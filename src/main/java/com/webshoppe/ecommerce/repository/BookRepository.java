...
public class BookRepository {
    private final static String BOOK_FIND_ALL = "SELECT bid, title, bookdesc, bookprice, aid FROM BooksDetails";
    ...
    public List<Book> findAll() {
        try {
            ...
            while (resultSet.next()) {
                Book book = new Book(resultSet.getString(1), resultSet.getString(2), resultSet.getString(3), resultSet.getBigDecimal(4), resultSet.getString(5));
                books.add(book);
            }
